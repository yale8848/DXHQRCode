...
public final class CameraManager {
	...
	public void setFlashlight(TextView txt) {
		...
		if (context.getPackageManager().hasSystemFeature(
			...
			Toast.makeText(context, "当前设备不支持闪光灯！！！", Toast.LENGTH_LONG).show();
		}

	}

	private void setDrawableTorch(TextView view) {

		Drawable drawable = context.getResources().getDrawable(R.drawable.flk);
	...
	private void setDrawableOff(TextView view) {
		Drawable drawable = context.getResources().getDrawable(R.drawable.flj);
		drawable.setBounds(0, 0, drawable.getMinimumWidth(),
				drawable.getMinimumHeight());
		view.setCompoundDrawables(null, drawable, null, null);
	}
